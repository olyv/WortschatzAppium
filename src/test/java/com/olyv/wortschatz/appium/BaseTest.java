...
public class BaseTest {
    ...
    private static final String DEVICE_NAME_CAPABILITY = "app-debug.apk";
    private static final String DEVICE_NAME_VALUE = "Nexus 5X API 26";
    ...
    private static final String PLATFORM_VERSION_VERSION = "8";
    ...
    private DesiredCapabilities getAndroidCapabilities() {
        ...
        capabilities.setCapability(PLATFORM_VERSION_CAPABILITY, PLATFORM_VERSION_VERSION);
